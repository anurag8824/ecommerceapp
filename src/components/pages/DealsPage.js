            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div class="bg-gray-100 p-4">
                    <section class="py-8 bg-white md:py-16 dark:bg-gray-900 antialiased">
                        <div class="max-w-screen-sm px-4 mx-auto 2xl:px-0">
                            <div class="lg:grid md:grid-cols-2 md:gap-8 xl:gap-16">
                                <div class="shrink-0 max-w-md md:max-w-sm mx-auto">
                                    <img class="w-full" src="./motorola.png" alt="" />
