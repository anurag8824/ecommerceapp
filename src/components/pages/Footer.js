...
//               <img src="infralogo.png" className="h-8 me-3" alt="FlowBite Logo" />
...
//           <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">Infyou Digital™</a>. All Rights Reserved.
//           </span>
  ...
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        {/* Mobile View */}
        <div className="flex md:hidden justify-around items-center border-t border-gray-200 dark:border-gray-700 py-4">
          <a href="/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            <FaHome size={24} />
